...
import com.demo.ai.app.model.Movie;
...
public class MovieStructuredOutputConverterController {

    private ChatClient chatClient;

    public MovieStructuredOutputConverterController(OpenAiChatModel chatModel) {
